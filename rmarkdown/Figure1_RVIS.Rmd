...
```{r, echo = FALSE}
source("~/ancestral_diversity/scripts/GeneList_VariantAnnotations.R")
source("~/ancestral_diversity/scripts/gnomAD_RVIS.R")

gnomAD_data <- fread("~/ancestral_diversity/data/UKB_RVIS.csv")
```
...
# UKBiobank
```{r}
UKB_data <- fread("~/ancestral_diversity/data/UKB_RVIS.csv")
source("~/ancestral_diversity/scripts/UKB_RVIS.R")
```
